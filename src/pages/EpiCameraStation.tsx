...
//   camDeviceId: string
//   camIpUrl: string
//   faceScanSeconds: number   // padrão: 8
//   epiScanSeconds: number   // padrão: 20  (window_seconds)
// }
...
//   const companyId = company?.details?.company_id ?? 1
...
//         company_id: String(stationCfg.companyId), window_seconds: String(CFG.window_seconds),
...
//       fetch(`${apiBase}/api/v1/epi/door/open`, { method: 'POST', body: fd, headers: stationCfg.apiKey ? { 'X-API-Key': stationCfg.apiKey } : {} }).catch(() => { })
//     } catch { }
//     if (lockIp) {
...
//       company_id: String(stationCfg.companyId), window_seconds: String(CFG.window_seconds),
//       fps: String(CFG.fps), confidence: String(CFG.confidence),
//       face_threshold: String(CFG.face_threshold), detect_faces: String(CFG.detect_faces), api_key: stationCfg.apiKey,
//     })
...
//         const r = await fetch(`${stationCfg.apiBase}/api/v1/epi/detect/frame?company_id=${stationCfg.companyId}`, { method: 'POST', body: fd, headers: stationCfg.apiKey ? { 'X-API-Key': stationCfg.apiKey } : {} })
...
//             <>
//               <div>
//                 <label style={lbl}>Tempo de reconhecimento facial (s)</label>
//                 <input style={inp} type="number"
//                   value={cfg.faceScanSeconds}
//                   onChange={e => set('faceScanSeconds', parseInt(e.target.value) || 8)}
//                   min={3} max={30} step={1}
//                 />
//                 <div style={{ fontSize: 11, color: '#6B7280', fontFamily: 'monospace', marginTop: 4 }}>
//                   Tempo para identificar o rosto antes de avançar · padrão: 8s
//                 </div>
//               </div>
//               <div>
//                 <label style={lbl}>Janela de verificação de EPI (s)</label>
//                 <input style={inp} type="number"
//                   value={cfg.epiScanSeconds}
//                   onChange={e => set('epiScanSeconds', parseInt(e.target.value) || 20)}
//                   min={5} max={60} step={1}
//                 />
//                 <div style={{ fontSize: 11, color: '#6B7280', fontFamily: 'monospace', marginTop: 4 }}>
//                   Duração da análise de EPIs · padrão: 20s
//                 </div>
//               </div>
//             </>
//           )}
