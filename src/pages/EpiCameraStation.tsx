...
// // // // // //             <CheckIcon style={{ width:15, height:15 }}/>Jaderson Sousa
// // // // // //           </span>
// // // // // //           )}
...
// // // // // // src/pages/EpiCameraStation.tsx  — v2.1
// // // // // // ─────────────────────────────────────────────────────────────────────────────
// // // // // // Melhorias v2.1:
// // // // // //   1. ResultOverlay exibe EPIs faltando (missing) em caso de DENIED_EPI
// // // // // //   2. lastMissing salvo no hook antes de fechar o scan
// // // // // // ─────────────────────────────────────────────────────────────────────────────
...
// // // // //   const [decision, setDecision]     = useState<Decision | null>(null)
// // // // //   const [direction, setDirection]   = useState<Direction>('ENTRY')
// // // // //   const [lastMissing, setLastMissing] = useState<string[]>([]) // ← v2.1
...
// // // // //     if (!mountedRef.current || phaseRef.current === 'scanning') return
// // // // //     closeScan(); setPhase('scanning'); setLastFrame(null); setDirection(dir)
// // // // //     setLastMissing([]) // ← reseta missing ao iniciar novo scan
// // // // //     const { apiBase } = stationCfg
// // // // //     const wsBase = apiBase.replace(/^http/, 'ws')
// // // // //     const params = new URLSearchParams({
// // // // //       company_id: '1', window_seconds: String(CFG.window_seconds),
...
// // // // //           setLastMissing((msg as FrameResult).missing ?? []) // ← v2.1: salva missing de cada frame
// // // // //         }
// // // // //         if (msg.type === 'decision') {
// // // // //           const d = msg as Decision; closeScan(); setDecision(d)
// // // // //           const p: Phase = d.access_decision === 'GRANTED' ? 'granted'
...
// // // // //   return { phase, lastFrame, decision, direction, openScan, goIdle, lastMissing } // ← v2.1: expõe lastMissing
// // // // // }
...
// // // // // // ─── RESULTADO ────────────────────────────────────────────────────────────────
// // // // // function ResultOverlay({ phase, decision, direction, hasLock, missing }: {
// // // // //   phase: Phase; decision: Decision | null; direction: Direction; hasLock: boolean;
// // // // //   missing: string[] // ← v2.1
// // // // // }) {
...
// // // // //   const Icon  = granted ? CheckCircleIcon : deniedEpi ? ShieldExclamationIcon : XCircleIcon
// // // // //   const title = granted
// // // // //     ? (direction === 'ENTRY' ? 'ACESSO LIBERADO' : 'SAÍDA REGISTRADA')
// // // // //     : deniedEpi ? 'EPI INCOMPLETO' : 'FACE NÃO IDENTIFICADA'
...
// // // // //       {/* Título */}
// // // // //       <div style={{ fontSize:'clamp(24px,5vw,44px)',fontWeight:900,color,letterSpacing:'-0.02em',marginBottom:10,textAlign:'center',textShadow:`0 0 30px ${color}88`,animation:'slideUp .4s ease .1s both',fontFamily:"'DM Sans',system-ui,sans-serif" }}>
// // // // //         {title}
// // // // //       </div>
...
// // // // //         <div style={{ marginTop:20,display:'flex',flexDirection:'column',alignItems:'center',gap:10,animation:'slideUp .4s ease .4s both' }}>
// // // // //           <div style={{ fontSize:11,color:'#9CA3AF',fontFamily:'monospace',textTransform:'uppercase',letterSpacing:'0.08em' }}>
// // // // //             EPIs faltando
// // // // //           </div>
...
// // // // //               }}>
// // // // //                 <ShieldExclamationIcon style={{ width:15,height:15,color:'#EF4444',flexShrink:0 }}/>
// // // // //                 {EPI_LABEL[epi] ?? epi}
// // // // //               </span>
// // // // //             ))}
// // // // //           </div>
...
// // // // //       {/* Fechadura aberta */}
// // // // //       {granted && hasLock && (
// // // // //         <div style={{ marginTop:14,display:'flex',alignItems:'center',gap:6,padding:'4px 12px',background:'rgba(16,185,129,0.1)',border:'1px solid rgba(16,185,129,0.3)',borderRadius:20,fontSize:12,color:'#86EFAC',fontFamily:'monospace',animation:'slideUp .4s ease .5s both' }}>
// // // // //           <LockClosedIcon style={{ width:12,height:12 }}/> Fechadura aberta
// // // // //         </div>
// // // // //       )}
// // // // //     </div>
...
// // // // //             hasLock={!!stationCfg.lockIp}
// // // // //             missing={logic.lastMissing} // ← v2.1
// // // // //           />
// // // // //         )}
// // // // //         {cam.ready&&<StatusBar phase={logic.phase} frame={logic.lastFrame} direction={logic.direction} onConfig={()=>setShowConfig(true)}/>}
...
// // // // src/pages/EpiCameraStation.tsx  — v3.0
// // // // ─────────────────────────────────────────────────────────────────────────────
// // // // Melhorias v3.0:
// // // //   1. Sistema de sub-fases do scan: face_scan → preparing → epi_scan
// // // //   2. face_scan: identifica o rosto (EPI ignorado na decisão)
// // // //   3. preparing: countdown visual "Coloque a balaclava" antes do EPI scan
// // // //   4. epi_scan: janela de conformidade de EPIs (lógica original)
// // // //   5. Face identificada antecipa o timer de face_scan automaticamente
// // // //   6. DENIED_FACE emitido se face não identificada após face_scan + preparing
// // // // ─────────────────────────────────────────────────────────────────────────────
...
// // //   detect_faces:              true,
// // //   result_show_ms:            5000,
// // //   idle_check_interval_ms:    1500,
// // //   person_trigger_confidence: 0.3,
// // //   // v3.0 — fases do scan
// // //   face_scan_seconds:         8,   // tempo para identificar rosto antes de forçar preparing
// // //   prepare_seconds:           4,   // countdown "coloque a balaclava"
// // // }
...
// // //   const faceDataRef         = useRef<{ code?: string; name?: string; confidence: number } | null>(null)
...
// // //   const setSubPhase = useCallback((sp: ScanSubPhase) => {
...
// // //   // ── Avança para fase "preparing" e depois "epi_scan" ──────────────────────
...
// // //     // Timer de segurança: se não identificou a face em face_scan_seconds, avança mesmo assim
// // //     subPhaseTimerRef.current = setTimeout(() => {
// // //       if (!mountedRef.current || phaseRef.current !== 'scanning') return
...
// // //           // Face identificada durante face_scan → antecipa o preparing
// // //           if (
// // //             fr.face_recognized &&
// // //             !faceIdentifiedRef.current &&
// // //             subPhaseRef.current === 'face_scan'
// // //           ) {
// // //             faceIdentifiedRef.current = true
// // //             faceDataRef.current = {
// // //               code:       fr.face_person_code,
// // //               name:       fr.face_person_name,
// // //               confidence: fr.face_confidence,
// // //             }
// // //             // Pequeno delay de 800ms para o usuário ver o feedback de face identificada
...
// // //         if (msg.type === 'decision') {
// // //           // Ignorar decisão se ainda não chegou na fase epi_scan
...
// // //           setDecision(d)
// // //           const p: Phase = d.access_decision === 'GRANTED'      ? 'granted'
// // //             : d.access_decision === 'DENIED_EPI'  ? 'denied_epi'
// // //             : 'denied_face'
// // //           setPhase(p)
// // //           if (d.access_decision === 'GRANTED') triggerDoor(d, dir)
...
// // //       if (wsTimerRef.current) { clearInterval(wsTimerRef.current); wsTimerRef.current = null }
// // //     }
// // //   }, [closeScan, setPhase, setSubPhase, startPreparing, goIdle, captureFrame, triggerDoor, stationCfg])
...
// // //   return {
// // //     phase, scanSubPhase, prepareCountdown,
// // //     lastFrame, decision, direction,
// // //     openScan, goIdle, lastMissing,
// // //   }
// // // }
...
// // // // ─── INSTRUÇÃO DE FASE DO SCAN (v3.0) ────────────────────────────────────────
// // // function ScanPhaseInstruction({ subPhase, countdown, frame }: {
// // //   subPhase: ScanSubPhase
// // //   countdown: number
...
// // //   const isFaceScan  = subPhase === 'face_scan'
...
// // //   const color  = isPreparing ? '#F59E0B' : faceOk ? '#10B981' : '#60A5FA'
// // //   const bgColor = isPreparing
// // //     ? 'rgba(245,158,11,0.13)'
// // //     : faceOk
// // //       ? 'rgba(16,185,129,0.12)'
// // //       : 'rgba(59,130,246,0.1)'
// // //   const borderColor = isPreparing
// // //     ? 'rgba(245,158,11,0.4)'
// // //     : faceOk
// // //       ? 'rgba(16,185,129,0.4)'
...
// // //         animation:     'phasePop 0.35s cubic-bezier(.34,1.56,.64,1)',
// // //         minWidth:      240,
// // //       }}>
...
// // //         }}>
// // //           {isPreparing
// // //             ? <><ShieldCheckIcon style={{ width:20,height:20 }}/> Coloque a balaclava</>
// // //             : faceOk
// // //               ? <><FaceSmileIcon style={{ width:20,height:20 }}/> Rosto identificado!</>
// // //               : <><UserIcon style={{ width:20,height:20 }}/> Mostre o rosto para a câmera</>
// // //           }
// // //         </div>

// // //         {/* Countdown no preparing */}
...
// // //         {/* Nome identificado durante face_scan */}
// // //         {isFaceScan && faceOk && faceName && (
// // //           <div style={{
// // //             fontSize:   13,
// // //             color:      '#86EFAC',
// // //             marginTop:  6,
// // //             fontFamily: 'monospace',
// // //           }}>
// // //             {faceName} · {Math.round(faceConf * 100)}% confiança
// // //           </div>
// // //         )}

// // //         {/* Subtítulo face_scan sem face ainda */}
// // //         {isFaceScan && !faceOk && (
// // //           <div style={{ fontSize:11, color:'#6B7280', fontFamily:'monospace', marginTop:4 }}>
// // //             Retire a balaclava temporariamente
// // //           </div>
// // //         )}
// // //       </div>
// // //     </div>
...
// // // // ─── STATUS BAR ───────────────────────────────────────────────────────────────
// // // function StatusBar({ phase, scanSubPhase, frame, direction, onConfig }: {
// // //   phase: Phase; scanSubPhase: ScanSubPhase; frame: FrameResult|null; direction: Direction; onConfig: ()=>void
// // // }) {
...
// // //   // Label da sub-fase
// // //   const subPhaseLabel: Record<ScanSubPhase, string> = {
// // //     face_scan:  'FACE',
// // //     preparing:  'PREP',
// // //     epi_scan:   'EPI',
// // //   }
// // //   const subPhaseColor: Record<ScanSubPhase, string> = {
// // //     face_scan:  '#60A5FA',
// // //     preparing:  '#F59E0B',
// // //     epi_scan:   '#10B981',
// // //   }
...
// // //       {/* Progress bar + rate só na fase epi_scan */}
...
// // //       {/* Badge de sub-fase durante scan */}
// // //       {scanning && (
// // //         <span style={{
// // //           background: `${subPhaseColor[scanSubPhase]}20`,
// // //           color:       subPhaseColor[scanSubPhase],
// // //           border:      `1px solid ${subPhaseColor[scanSubPhase]}50`,
// // //           borderRadius: 20,
// // //           padding:     '2px 8px',
// // //           fontSize:    10,
// // //           fontFamily:  'monospace',
...
// // //   // Sidebar de EPI só aparece na fase epi_scan
...
// // //         {/* Overlay de detecções — apenas durante epi_scan */}
...
// // //           <StatusBar
// // //             phase={logic.phase}
// // //             scanSubPhase={logic.scanSubPhase}
// // //             frame={logic.lastFrame}
// // //             direction={logic.direction}
// // //             onConfig={()=>setShowConfig(true)}
// // //           />
// // //         )}

// // //         {/* Instrução de fase (face_scan / preparing) */}
// // //         {scanning && logic.scanSubPhase !== 'epi_scan' && (
// // //           <ScanPhaseInstruction
// // //             subPhase={logic.scanSubPhase}
// // //             countdown={logic.prepareCountdown}
// // //             frame={logic.lastFrame}
// // //           />
// // //         )}

// // //         {/* Nome ao identificar (mantido, mas só durante face_scan) */}
...
// // //         {/* Progress bar — apenas durante epi_scan */}
// // //         {scanning && logic.scanSubPhase === 'epi_scan' && (
// // //           <div style={{ position:'absolute',bottom:0,left:0,right:0,height:4,background:'rgba(0,0,0,0.4)' }}>
// // //             <div style={{ height:'100%',background:`linear-gradient(90deg,#3B82F6,${(logic.lastFrame?.session_compliant_rate??0)>0.5?'#10B981':'#EF4444'})`,width:`${(logic.lastFrame?.window_progress??0)*100}%`,transition:'width .3s' }}/>
// // //           </div>
...
// // //         {/* Sidebar narrow (portrait) — apenas durante epi_scan */}
// // //         {showEpiSidebar && isNarrow && <EpiSidebar frame={logic.lastFrame} isNarrow={true}/>}
// // //       </div>

// // //       {/* Sidebar lateral (landscape) — apenas durante epi_scan */}
...
// //               <UserIcon style={{ width:28,height:28,color:'#10B981' }}/>
// //             </div>
// //             <div style={{ fontSize:'clamp(28px,6vw,48px)',fontWeight:900,color:'#10B981',letterSpacing:'-0.03em',lineHeight:1,fontFamily:"'DM Sans',system-ui,sans-serif",animation:'nameGlow 2s ease-in-out infinite',textAlign:'center',textShadow:'0 0 30px #10B98188',background:'rgba(6,40,30,0.85)',backdropFilter:'blur(8px)',padding:'10px 28px',borderRadius:16,border:'1px solid rgba(16,185,129,0.25)' }}>
// //               {logic.lastFrame.face_person_name ?? logic.lastFrame.face_person_code}
// //             </div>
// //             <div style={{ fontSize:12,color:'#86EFAC',fontFamily:'monospace',marginTop:5,background:'rgba(16,185,129,0.1)',border:'1px solid rgba(16,185,129,0.3)',borderRadius:20,padding:'2px 10px' }}>
// //               {Math.round((logic.lastFrame.face_confidence??0)*100)}% confiança
...
//   // ── Reabre WebSocket com janela limpa (usado na transição para epi_scan) ──
//   const openEpiWs = useCallback((apiBase: string, onMsg: (ev: MessageEvent) => void) => {
//     if (wsTimerRef.current) { clearInterval(wsTimerRef.current); wsTimerRef.current = null }
//     if (wsRef.current) { wsRef.current.close(); wsRef.current = null }
//     const wsBase = apiBase.replace(/^http/, 'ws')
//     const params = new URLSearchParams({
...
//       face_threshold: String(CFG.face_threshold), detect_faces: String(CFG.detect_faces),
//     })
//     const ws2 = new WebSocket(`${wsBase}/api/v1/epi/ws/epi-stream?${params}`)
//     wsRef.current = ws2
//     ws2.onmessage = onMsg
//     ws2.onopen = () => {
//       const interval = Math.round(1000 / CFG.fps)
...
//     // Após prepare_seconds → epi_scan: REABRE o WS para janela limpa de conformidade
//     subPhaseTimerRef.current = setTimeout(() => {
//       if (!mountedRef.current || phaseRef.current !== 'scanning') return
//       setSubPhase('epi_scan')
//       openEpiWs(apiBase, onMsg)
//     }, CFG.prepare_seconds * 1000)
//   }, [clearSubPhaseTimers, setSubPhase, openEpiWs])
...
//     // Handler de mensagens WS — definido antes para ser reutilizado ao reabrir na epi_scan
...
//     // Timer de segurança: avança mesmo se face não for identificada
//     subPhaseTimerRef.current = setTimeout(() => {
//       if (!mountedRef.current || phaseRef.current !== 'scanning') return
//       if (subPhaseRef.current === 'face_scan') {
//         startPreparing(apiBase, handleWsMessage)
...
//     // Abre WS inicial (fase face_scan + preparing — frames enviados mas decisão ignorada)
//     const wsBase = apiBase.replace(/^http/, 'ws')
//     const params = new URLSearchParams({
//       company_id: '1', window_seconds: String(CFG.window_seconds),
//       fps: String(CFG.fps), confidence: String(CFG.confidence),
...
//       if (wsTimerRef.current) { clearInterval(wsTimerRef.current); wsTimerRef.current = null }
//     }
//   }, [closeScan, setPhase, setSubPhase, startPreparing, openEpiWs, goIdle, captureFrame, triggerDoor, stationCfg])
...
function useKioskLogic(
  ...
  // ── Avança para fase "preparing" e depois "epi_scan" ──────────────────────
  // Ao entrar em epi_scan, reabre o WS para o backend iniciar janela do zero
  const startPreparing = useCallback((apiBase: string, onMsg: (ev: MessageEvent) => void) => {
    clearSubPhaseTimers()
    setSubPhase('preparing')
    setPrepareCountdown(CFG.prepare_seconds)
    ...
    // Após prepare_seconds → epi_scan: fecha WS atual e abre nova sessão limpa
    subPhaseTimerRef.current = setTimeout(() => {
      if (!mountedRef.current || phaseRef.current !== 'scanning') return
      setSubPhase('epi_scan')
      ...
      if (wsTimerRef.current) { clearInterval(wsTimerRef.current); wsTimerRef.current = null }
      if (wsRef.current) { wsRef.current.close(); wsRef.current = null }
      // Abre nova sessão — backend conta window_seconds do zero
      ...
      const ws2 = new WebSocket(`${wsBase2}/api/v1/epi/ws/epi-stream?${params2}`)
      wsRef.current = ws2
      ws2.onmessage = onMsg
      ws2.onopen = () => {
  ...
  }, [clearSubPhaseTimers, setSubPhase, captureFrame])
