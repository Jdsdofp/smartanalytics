...
//             { icon: ChartBarIcon, label: 'Device Logs & Monitoring', path: '/MN0400_211', permissionCode: 'MN0400_510' },
...
//         children: [
//           { icon: ChartPieIcon, label: 'Certificate Status Overview', path: '/MN0400_511' },
