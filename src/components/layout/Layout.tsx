    ...
    <>
      ...
      {showEmbedModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4 backdrop-blur-md">
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className={`px-6 py-3 rounded-lg font-medium transition-all ${copySuccess
