...
export function OrdersTable({ orders, loading }: OrdersTableProps) {
  ...
  // Modal state
  const [selectedOrder, setSelectedOrder] = useState<{ flowId: number; orderCode: string } | null>(null);
  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
        ...
        {/* ... (manter toda a tabela existente) */}
                  ...
                  paginatedOrders.map((order, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm font-semibold text-gray-900 max-w-xs truncate" title={order.subject}>
                          {order.subject || '-'}
                        </div>
                      ...
                      <td className="px-6 py-4">
                        <div>
                          ...
                          <div className="text-xs text-gray-500 font-medium mt-0.5">{order.job_class_name}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-3">
                          <div className="flex-1 bg-gray-200 rounded-full h-2.5 overflow-hidden shadow-inner">
                            <div
                              className={`h-2.5 rounded-full transition-all duration-500 ${getProgressBarColor(order.percentual_concluido)}`}
                      ...
                      <td className="px-6 py-4">
                        <div>
                          <div className="text-sm font-semibold text-gray-900">{order.to_custody_name}</div>
                          <div className="text-xs text-gray-500 font-medium mt-0.5">{order.to_zone_name}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        {/* Pagination Footer - manter existente */}
