...
import type { CameraHook } from '../../../hooks/useCamAutomation';
import { useBodyFramingDetection } from '../../../hooks/useBodyFramingDetection'; // ✅ CORRIGIDO
...
export default function EpiScanScreen({
  ...
  // ✅ Hook de detecção de enquadramento usando MediaPipe (local)
  //@ts-ignore
  const { feedback, isWellFramed, shouldBlock, poseResults, videoSize } = useBodyFramingDetection({
    videoElement: videoRef.current,
    enabled: true,
  });
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ✅ NOVO: Overlay do MediaPipe Pose - skeleton e bounding box */}
          {status === 'idle' && poseResults && (
            <PoseOverlay
              results={poseResults}
