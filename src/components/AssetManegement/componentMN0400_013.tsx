...
import AssetGPSMap from './Maps/AssetGPSMap';
...
export default function AssetManagement() {
  ...
  //       },
  //       legend: {
  //         data: [t('assetManagement.dashboard.financialSummary.purchaseCost'), t('assetManagement.dashboard.financialSummary.replacementCost')],
  //         bottom: 10,
  ...
  //       series: [
  //         {
  //           name: t('assetManagement.dashboard.financialSummary.purchaseCost'),
  //           type: 'bar',
  ...
  //         },
  //         {
  //           name: t('assetManagement.dashboard.financialSummary.replacementCost'),
  //           type: 'bar',
      ...
      series: [
        {
          name: t('assetManagement.dashboard.financialSummary.purchaseCost'),
          type: 'bar',
          stack: 'total', // Adicione stack para empilhar as barras
          data: sortedData.map((d: any) => d.purchase),
          itemStyle: {
            color: '#5B93FF',
            borderRadius: [0, 4, 4, 0]
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg font-medium">{t('assetManagement.loading.title')}</p>
          <p className="text-gray-500 text-sm mt-2">{t('assetManagement.loading.message')}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('assetManagement.error.title')}</h2>
          <p className="text-gray-600 mb-4">{error}</p>
          <button
            onClick={() => window.location.reload()}
            className="px-6 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-colors"
          >
            {t('assetManagement.error.retry')}
          </button>
        </div>
      </div>
    );
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 ${activeSection === 'dashboard'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.dashboard')}</span>
              </div>
            </button>
          </li>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 relative ${activeSection === 'tracking'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.tracking')}</span>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 ${activeSection === 'custody'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.custody')}</span>
              </div>
            </button>
          </li>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 ${activeSection === 'financial'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.financial')}</span>
              </div>
            </button>
          </li>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 relative ${activeSection === 'maintenance'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.maintenance')}</span>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 ${activeSection === 'audit'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.audit')}</span>
              </div>
            </button>
          </li>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 ${activeSection === 'reports'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.reports')}</span>
              </div>
            </button>
          </li>
          ...
          <li className="list-none h-full">
            ...
            >
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full transition-all duration-200 ${activeSection === 'exports'
                ...
                <span className="text-sm font-medium max-md:hidden">{t('assetManagement.navigation.exports')}</span>
              </div>
            </button>
          </li>
        </ul>
      ...
      <div className="ml-0 p-1 min-h-[calc(100vh-130px)]">
        ...
        {activeSection === 'dashboard' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.dashboard.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.dashboard.subtitle')}</p>
            </div>
            ...
            <div className="grid grid-cols-6 gap-5 mb-5 max-xl:grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1">
              ...
              <div className="bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:-translate-y-1 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 text-gray-500">
                  ...
                  <span className="text-xs font-medium">{t('assetManagement.kpi.totalAssets.label')}</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:-translate-y-1 relative overflow-hidden">
                <div className="flex items-center gap-2 text-gray-500">
                  <ChartBarIcon className="w-4 h-4" />
                  <span className="text-xs font-medium">{t('assetManagement.kpi.totalCategories.label')}</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:-translate-y-1 relative overflow-hidden">
                <div className="flex items-center gap-2 text-gray-500">
                  <CurrencyDollarIcon className="w-4 h-4" />
                  <span className="text-xs font-medium">{t('assetManagement.kpi.totalInvestment.label')}</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:-translate-y-1 relative overflow-hidden">
                <div className="flex items-center gap-2 text-gray-500">
                  ...
                  <span className="text-xs font-medium">{t('assetManagement.kpi.misplacedItems.label')}</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:-translate-y-1 relative overflow-hidden">
                <div className="flex items-center gap-2 text-gray-500">
                  <WrenchScrewdriverIcon className="w-4 h-4" />
                  <span className="text-xs font-medium">{t('assetManagement.kpi.maintenanceDue.label')}</span>
                </div>
              ...
              <div className="bg-white rounded-2xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition-all hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:-translate-y-1 relative overflow-hidden">
                <div className="flex items-center gap-2 text-gray-500">
                  ...
                  <span className="text-xs font-medium">{t('assetManagement.kpi.serialCompletion.label')}</span>
                </div>
            ...
            <div className="grid grid-cols-2 gap-5 mb-5 max-lg:grid-cols-1">
              <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-center mb-5">
                  <div className="text-base font-semibold text-gray-900">{t('assetManagement.dashboard.charts.assetsByDepartment')}</div>
                  <div className="flex gap-2">
                    <button className="w-9 h-9 rounded-lg border-0 bg-gray-100 text-gray-600 cursor-pointer flex items-center justify-center hover:bg-gray-300 transition-all" title={t('assetManagement.dashboard.charts.download')}>
                      <ArrowDownTrayIcon className="w-4 h-4" />
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-center mb-5">
                  <div className="text-base font-semibold text-gray-900">{t('assetManagement.dashboard.charts.avgCostByCategory')}</div>
                  <div className="flex gap-2">
                    <button className="w-9 h-9 rounded-lg border-0 bg-gray-100 text-gray-600 cursor-pointer flex items-center justify-center hover:bg-gray-300 transition-all" title={t('assetManagement.dashboard.charts.download')}>
                      <ArrowDownTrayIcon className="w-4 h-4" />
                    </button>
            ...
            <div className="grid grid-cols-2 gap-5 max-lg:grid-cols-1">
              <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-center mb-5">
                  <div className="text-base font-semibold text-gray-900">{t('assetManagement.dashboard.charts.assetsByCostCenter')}</div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-center mb-5">
                  <div className="text-base font-semibold text-gray-900">{t('assetManagement.dashboard.charts.investmentByCostCenter')}</div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-5 p-5 max-lg:grid-cols-1">
              <div className="bg-white rounded-xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <h3 className="mb-4 text-base font-semibold">{t('assetManagement.dashboard.assetDistribution.title')}</h3>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.assetDistribution.inUse')}</span>
                  <span className="text-base font-semibold text-gray-900">
                    {executive.distribution.inUse.toLocaleString()} ({((executive.distribution.inUse / kpi.totalAssets) * 100).toFixed(1)}%)
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.assetDistribution.available')}</span>
                  <span className="text-base font-semibold text-gray-900">
                    {executive.distribution.available.toLocaleString()} ({((executive.distribution.available / kpi.totalAssets) * 100).toFixed(1)}%)
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.assetDistribution.inTransit')}</span>
                  <span className="text-base font-semibold text-gray-900">
                    {executive.distribution.inTransit.toLocaleString()} ({((executive.distribution.inTransit / kpi.totalAssets) * 100).toFixed(1)}%)
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.assetDistribution.underMaintenance')}</span>
                  <span className="text-base font-semibold text-gray-900">
              ...
              <div className="bg-white rounded-xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <h3 className="mb-4 text-base font-semibold">{t('assetManagement.dashboard.financialSummary.title')}</h3>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.financialSummary.purchaseCost')}</span>
                  <span className="text-base font-semibold text-gray-900">
                    ${(executive.financial.purchaseCost / 1000000).toFixed(2)}M
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.financialSummary.replacementCost')}</span>
                  <span className="text-base font-semibold text-gray-900">
                    ${(executive.financial.replacementCost / 1000000).toFixed(2)}M
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.financialSummary.netBookValue')}</span>
                  <span className="text-base font-semibold text-gray-900">
                    ${(executive.financial.netBookValue / 1000000).toFixed(2)}M
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-300 last:border-b-0">
                  <span className="text-sm text-gray-600">{t('assetManagement.dashboard.financialSummary.depreciation')}</span>
                  <span className="text-base font-semibold text-gray-900">
        ...
        {activeSection === 'tracking' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.tracking.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.tracking.subtitle')}</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-5 mb-5 max-lg:grid-cols-1">
              <div className="bg-white rounded-xl p-5 border-l-4 border-[#FF4757] shadow-[0_2px_8px_rgba(0,0,0,0.06)] bg-[rgba(255,71,87,0.05)]">
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <div className="text-sm font-semibold">{t('assetManagement.tracking.alerts.outOfPlace.title')}</div>
                </div>
                <div className="text-[13px] text-gray-600 leading-relaxed"
                  dangerouslySetInnerHTML={{
                    __html: t('assetManagement.tracking.alerts.outOfPlace.description', {
                      count: tracking.totalOutOfPlace,
                      value: (tracking.totalValueAtRisk / 1000).toFixed(0),
                      days: tracking.avgDaysOutOfPlace
                    })
                  }}
                />
              </div>
              ...
              <div className="bg-white rounded-xl p-5 border-l-4 border-[#FF9500] shadow-[0_2px_8px_rgba(0,0,0,0.06)] bg-[rgba(255,149,0,0.05)]">
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <div className="text-sm font-semibold">{t('assetManagement.tracking.alerts.unread.title')}</div>
                </div>
                <div className="text-[13px] text-gray-600 leading-relaxed"
                  dangerouslySetInnerHTML={{
                    __html: t('assetManagement.tracking.alerts.unread.description', {
                      count: alerts.critical.unread
                    })
                  }}
                />
              </div>
              ...
              <div className="bg-white rounded-xl p-5 border-l-4 border-[#5B93FF] shadow-[0_2px_8px_rgba(0,0,0,0.06)] bg-[rgba(91,147,255,0.05)]">
                <div className="flex items-center gap-2.5 mb-2">
                  ...
                  <div className="text-sm font-semibold">{t('assetManagement.tracking.alerts.alarmed.title')}</div>
                </div>
                <div className="text-[13px] text-gray-600 leading-relaxed"
                  dangerouslySetInnerHTML={{
                    __html: t('assetManagement.tracking.alerts.alarmed.description', {
                      count: alerts.critical.alarmed
                    })
                  }}
                />
              </div>
        ...
        {activeSection === 'custody' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.custody.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.custody.subtitle')}</p>
            </div>
        ...
        {activeSection === 'financial' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.financial.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.financial.subtitle')}</p>
            </div>

            {/* Financial KPIs */}
            <div className="grid grid-cols-4 gap-5 mb-5 max-lg:grid-cols-2 max-md:grid-cols-1">
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.financial.kpi.totalPurchaseCost')}</div>
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.financial.kpi.replacementCost')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.financial.kpi.netBookValue')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.financial.kpi.uninsuredValue')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
                  ${(financial.uninsuredValue / 1000).toFixed(0)}K
                </div>
                <div className="flex items-center gap-1 font-medium text-[#FF4757]">
                  <ExclamationTriangleIcon className="w-3 h-3" />
                  <span className="text-xs">{t('assetManagement.financial.kpi.atRisk')}</span>
                </div>
              </div>
            </div>
            ...
            {alerts.financial.missingCostCenter > 0 && (
              <div className="bg-white rounded-xl p-5 border-l-4 border-[#FF4757] mb-4 shadow-[0_2px_8px_rgba(0,0,0,0.06)] bg-[rgba(255,71,87,0.05)]">
                <div className="flex items-center gap-2.5 mb-2">
                  <ExclamationTriangleIcon className="w-5 h-5 text-[#FF4757]" />
                  <div className="text-sm font-semibold">{t('assetManagement.financial.alerts.missingCostCenter.title')}</div>
                </div>
                <div className="text-[13px] text-gray-600 leading-relaxed"
                  dangerouslySetInnerHTML={{
                    __html: t('assetManagement.financial.alerts.missingCostCenter.description', {
                      count: alerts.financial.missingCostCenter
                    })
                  }}
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-5 mb-5 max-lg:grid-cols-1">
              <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-center mb-5">
                  <div className="text-base font-semibold text-gray-900">{t('assetManagement.financial.charts.depreciation')}</div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="flex justify-between items-center mb-5">
                  <div className="text-base font-semibold text-gray-900">{t('assetManagement.financial.charts.coverage')}</div>
                </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)] overflow-x-auto">
              <div className="flex justify-between items-center p-0 mb-5">
                <div className="text-base font-semibold text-gray-900">{t('assetManagement.financial.costCenterPerformance.title')}</div>
              </div>
              <table className="w-full border-collapse">
                <thead className="bg-gray-100 rounded-lg">
                  <tr>
                    <th className="p-3 text-left font-semibold text-xs uppercase text-gray-600 tracking-wide">{t('assetManagement.financial.costCenterPerformance.columns.costCenter')}</th>
                    <th className="p-3 text-left font-semibold text-xs uppercase text-gray-600 tracking-wide">{t('assetManagement.financial.costCenterPerformance.columns.assets')}</th>
                    <th className="p-3 text-left font-semibold text-xs uppercase text-gray-600 tracking-wide">{t('assetManagement.financial.costCenterPerformance.columns.totalInvestment')}</th>
                    <th className="p-3 text-left font-semibold text-xs uppercase text-gray-600 tracking-wide">{t('assetManagement.financial.costCenterPerformance.columns.utilization')}</th>
                    <th className="p-3 text-left font-semibold text-xs uppercase text-gray-600 tracking-wide">{t('assetManagement.financial.costCenterPerformance.columns.dataQuality')}</th>
                  </tr>
                </thead>
                <tbody>
        ...
        {activeSection === 'maintenance' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.maintenance.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.maintenance.subtitle')}</p>
            </div>

            {/* Maintenance KPIs */}
            <div className="grid grid-cols-4 gap-5 mb-5 max-lg:grid-cols-2 max-md:grid-cols-1">
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.maintenance.kpi.overdue.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
                  {maintenance.overdue}
                </div>
                <div className="flex items-center gap-1 font-medium text-[#FF4757]">
                  <ExclamationTriangleIcon className="w-3 h-3" />
                  <span className="text-xs">{t('assetManagement.maintenance.kpi.overdue.status')}</span>
                </div>
              </div>

              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.maintenance.kpi.dueThisWeek.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.maintenance.kpi.dueThisMonth.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.maintenance.kpi.completedThisMonth.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
                  {maintenance.completedThisMonth}
                </div>
                <div className="flex items-center gap-1 font-medium text-[#2DD36F]">
                  <CheckCircleIcon className="w-3 h-3" />
                  <span className="text-xs">{t('assetManagement.maintenance.kpi.completedThisMonth.rate', { rate: maintenance.completionRate })}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
              <div className="flex justify-between items-center mb-5">
                <div className="text-base font-semibold text-gray-900">{t('assetManagement.maintenance.charts.schedule')}</div>
              </div>
        ...
        {activeSection === 'audit' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.audit.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.audit.subtitle')}</p>
            </div>

            {/* Audit KPIs */}
            <div className="grid grid-cols-4 gap-5 mb-5 max-lg:grid-cols-2 max-md:grid-cols-1">
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.audit.kpi.workOrderPassRate.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
                ...
                <div className={`flex items-center gap-1 font-medium ${audit.workOrderPassRate >= 80 ? 'text-[#2DD36F]' : 'text-[#FF9500]'
                  ...
                  <span className="text-xs">
                    {audit.workOrderPassRate >= 80 ? t('assetManagement.audit.kpi.workOrderPassRate.good') : t('assetManagement.audit.kpi.workOrderPassRate.needsImprovement')}
                  </span>
                </div>
              </div>

              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.audit.kpi.totalWorkOrders.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.audit.kpi.passed.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
                  {audit.passed}
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-5 flex flex-col gap-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">{t('assetManagement.audit.kpi.failed.label')}</div>
                <div className="text-[32px] font-bold text-gray-900 leading-none">
                  {audit.failed}
                </div>
                <div className="flex items-center gap-1 font-medium text-[#FF4757]">
                  <ExclamationTriangleIcon className="w-3 h-3" />
                  <span className="text-xs">{t('assetManagement.audit.kpi.failed.status')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
              <div className="flex justify-between items-center mb-5">
                <div className="text-base font-semibold text-gray-900">{t('assetManagement.audit.charts.complianceByCategory')}</div>
              </div>
        ...
        {activeSection === 'exports' && (
          <div className="animate-[fadeIn_0.3s]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-2">{t('assetManagement.exports.title')}</h1>
              <p className="text-sm text-gray-600">{t('assetManagement.exports.subtitle')}</p>
            </div>
