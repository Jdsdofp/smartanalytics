...
const HealthScoreDashboard: React.FC<{ companyId: any }> = ({ companyId }) => {
  ...
  return (
    <div className="space-y-6 w-full max-w-7xl mx-auto">
      {/* Tabela de Dados - Agora mais larga */}
                ...
                >
                  ...
                  <td className="px-6 py-2.5 whitespace-nowrap">
                    <div className="flex items-center space-x-2">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold border ${getScoreColor(item.VALUE)}`}>
                        {item.VALUE}%
                      </span>
                  ...
                  <td className="px-6 py-2.5 whitespace-nowrap">
                    <span className={`text-sm font-semibold ${getScoreTextColor(item.VALUE)}`}>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="px-4 py-1.5 text-sm font-medium border border-gray-300 rounded-md hover:bg-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              > 
