...
export default function DeviceLogsView() {
  ...
  }, [companyId, lowBatteryPage, lowBatteryLimit, activeTab, t]);
        ...
        <nav className="-mb-px flex space-x-8 max-[856px]:overflow-x-auto">
          {[
            ...
            <button
              ...
              className={`cursor-pointer flex items-center gap-2 py-4 px-1 border-b-2 font-medium text-sm ${activeTab === tab.id
                ? 'border-blue-500 text-blue-600'
