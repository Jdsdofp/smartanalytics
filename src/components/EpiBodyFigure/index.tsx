...
//             style={{
//               position: 'absolute', top: '6%', left: '48%', transform: 'translateX(-50%)', width: '30%', opacity: 0.9, zIndex: 2,
//               filter: 'drop-shadow(0 0 6px rgba(252, 56, 56, 0.8))', animation: 'blink 1.2s ease-in-out infinite'
//             }} />
//         )}
...
//             style={{
//               position: 'absolute', top: '48%', right: '9%', width: '19%', opacity: 0.9, zIndex: 2,
...
//             style={{
//               position: 'absolute', top: '48%', left: '9%', width: '19%', opacity: 0.9, zIndex: 2,
//               filter: 'drop-shadow(0 0 6px rgba(239,68,68,0.8))', animation: 'blink 1.2s ease-in-out infinite'
//             }} />
//         )}
...
//             style={{
//               position: 'absolute', bottom: '7%', left: '49%', transform: 'translateX(-50%)', width: '60%', opacity: 0.9, zIndex: 2,
//               filter: 'drop-shadow(0 0 6px rgba(239,68,68,0.8))', animation: 'blink 1.2s ease-in-out infinite'
//             }} />
//         )}
