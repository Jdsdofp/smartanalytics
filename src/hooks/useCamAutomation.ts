...
//     console.log('🔍 [CAM] ✅ Frame capturado:', blob.size, 'bytes');
//     return blob;
...
//   // ✅ Câmera IP não precisa de stream
//   if (sourceType === 'ip_url') {
//     console.log(`🔍 [CAM] Role ${role} é IP - não inicia stream`);
//     return null;
//   }
...
//     setLoading(false);
//   }
// }, [assignments, sourceTypes, streams]); // ✅ Adicionar sourceTypes
