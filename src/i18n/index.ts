...
//     if (savedUser) {
//       const settings = JSON.parse(savedUser);
...
// Função para carregar idioma do sessionStorage
const getSavedLanguage = () => {
  try {
    const savedUser = sessionStorage.getItem('user');
...
i18n
  ...
  .init({
    ...
    lng: getSavedLanguage(), // Define o idioma inicial baseado no sessionStorage
    fallbackLng: "en",
    interpolation: { 
      escapeValue: false 
    },
